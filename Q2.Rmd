...
```{r start latex doc}
text_i = "\\subsubsection{Subtask(i)}
...
enum_str_list(
  paste0(format(
    round(msft_a_i_max_1_day_neg_change,2),
         nsmall = 2, scientific = F
         )
  ), "\euro"),
  " with " ,paste0(100*(1-alphas), "%"), "Confidence.
...
enum_str_list(
  paste0(format(
    round(v_a_i_max_1_day_neg_change,2),
         nsmall = 2, scientific = F
         )
  ), "\euro")," with " ,paste0(100*(1-alphas), "%"), "Confidence.
