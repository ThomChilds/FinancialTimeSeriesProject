...
end_estimation <- nrow(data_ts)  # End index of the estimation period
start_forecast <- end_estimation - 9  # Start index of the forecast period (last 10 records)
end_forecast <- end_estimation  # End index of the forecast period
