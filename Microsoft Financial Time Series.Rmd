...
v_res <- residuals(fit_visa)
Box.test(v_res, lag = 10, type = "Ljung-Box")
Box.test(v_res^2, lag = 10, type = "Ljung-Box")
describe(v_res)
```
...
# TODO : check if all the code below is ok 
#        !!!!!!!
#        !!!!!!!
#        !!!!!!!
#        !!!!!!!
...
# I belive it needs some more metrics to compare the results
```
